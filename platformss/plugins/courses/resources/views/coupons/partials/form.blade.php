@php
    ...
    $checkoutData = session($checkoutToken, []);
    $couponCode = \Illuminate\Support\Arr::get($checkoutData, 'coupon_code');
    $couponAmount = \Illuminate\Support\Arr::get($checkoutData, 'coupon_amount');
@endphp
