          ...
          <div class="course-detail-chips">
            ...
            @endif
                @if($course->price)
                    @php
                        ...
                        $dynamicPrice = app(\Botble\PriceConfigurator\Services\PriceConfiguratorService::class)
                            ->calculatePrice($basePrice, \Botble\PriceConfigurator\Enums\TargetTypeEnum::COURSE, $course->id, auth('customer')->user() ?? null);
                        $discountAmount = $basePrice - $dynamicPrice;
                    @endphp
                ...
                {{ format_price($dynamicPrice) }}
                        ...
                        @else
                            <span class="price fw-bold">{{ format_price($basePrice) }}</span>
                        @endif
                    </div>
