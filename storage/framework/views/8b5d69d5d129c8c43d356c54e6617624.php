<div class="row">
    ...
    <div class="col">
        <div class="text-truncate">
            ...
            <?php if($history->module != 'user' || (class_exists($history->user_type) && empty($history->user)) || (class_exists($history->user_type) && $history->user->id != Auth::guard()->id())): ?>
...
<?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/plugins/audit-log/resources/views/activity-line.blade.php ENDPATH**/ ?>