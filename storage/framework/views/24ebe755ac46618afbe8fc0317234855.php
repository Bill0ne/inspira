...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.header.cell','data' => ['class' => 'w-25']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-25']); ?>
                    <?php echo e(trans('core/setting::setting.template')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('core/setting::setting.description')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'template-name w-25']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'template-name w-25']); ?>
                        <?php
                            $isOn = (bool) (get_setting_email_status($type, $module, $key));
                        ?>

                        <a
                            href="<?php echo e(route('settings.email.template.edit', [$type, $module, $key])); ?>"
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-muted text-decoration-line-through' => !$isOn]); ?>"
                            <?php if(!$isOn): ?>
                                data-bs-toggle="tooltip"
                                title="<?php echo e(trans('core/setting::setting.email.template_off_status_helper')); ?>"
                            <?php endif; ?>
                        >
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(trans($template['description'])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['color' => 'primary','tag' => 'a','href' => route('settings.email.template.edit', [$type, $module, $key]),'icon' => 'ti ti-pencil','iconOnly' => true,'size' => 'sm','tooltip' => trans('core/base::tables.edit')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('settings.email.template.edit', [$type, $module, $key])),'icon' => 'ti ti-pencil','icon-only' => true,'size' => 'sm','tooltip' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::tables.edit'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/core/setting/resources/views/template-line.blade.php ENDPATH**/ ?>