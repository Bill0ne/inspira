...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('invoices.generate', ['invoice' => $invoice->id, 'type' => 'print']),'target' => '_blank','icon' => 'ti ti-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('invoices.generate', ['invoice' => $invoice->id, 'type' => 'print'])),'target' => '_blank','icon' => 'ti ti-printer']); ?>
        <?php echo e(trans('plugins/hotel::invoice.print')); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('invoices.generate', ['invoice' => $invoice->id, 'type' => 'download']),'target' => '_blank','icon' => 'ti ti-download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('invoices.generate', ['invoice' => $invoice->id, 'type' => 'download'])),'target' => '_blank','icon' => 'ti ti-download']); ?>
        <?php echo e(trans('plugins/hotel::invoice.download')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
            <div class="row">
                <div class="col-6 offset-6 text-end">
                    <p class="h3"><?php echo e(trans('plugins/hotel::invoice.heading')); ?></p>
                    <p class="mb-1"><?php echo e($invoice->customer_name); ?></p>
            ...
            <div class="my-5">
                <div class="row">
                    <div class="col-lg-3">
                        <strong><?php echo e(trans('plugins/hotel::invoice.code')); ?>:</strong>
                        #<?php echo e($invoice->code); ?>

                    </div>
                    <div class="col-lg-3">
                        <strong><?php echo e(trans('plugins/hotel::invoice.status')); ?>:</strong>
                        <?php echo $invoice->status->toHtml(); ?>

                    </div>
                    <div class="col-lg-3">
                        <strong><?php echo e(trans('plugins/hotel::invoice.purchase_at')); ?>:</strong>
                    ...
                    <?php if($invoice->payment): ?>
                        <div class="col-lg-3">
                            <strong><?php echo e(trans('plugins/hotel::invoice.payment_method')); ?>:</strong>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['class' => 'table-transparent','striped' => false,'hover' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'table-transparent','striped' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'hover' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(trans('plugins/hotel::invoice.item.name')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(trans('plugins/hotel::invoice.item.qty')); ?>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                        <?php echo e(trans('plugins/hotel::invoice.amount')); ?>
...
<?php endif; ?>
                            ...
                            <td class="text-center">
                                <strong><?php echo e(format_price($item->sub_total)); ?></strong>
                            </td>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                        <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['class' => 'text-end','colspan' => '2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end','colspan' => '2']); ?>
                            <?php echo e(trans('plugins/hotel::invoice.sub_total')); ?>:
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <strong><?php echo e(format_price($invoice->sub_total)); ?></strong>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end','colspan' => '2']); ?>
                                <?php echo e(trans('plugins/hotel::invoice.tax_amount')); ?>:
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <strong><?php echo e(format_price($invoice->tax_amount)); ?></strong>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end','colspan' => '2']); ?>
                                <?php echo e(trans('plugins/hotel::invoice.discount_amount')); ?>:
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <strong><?php echo e(format_price($invoice->discount_amount)); ?></strong>
                                <p>(<?php echo e($invoice->reference->coupon_code); ?>)</p>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end','colspan' => '2']); ?>
                            <?php echo e(trans('plugins/hotel::invoice.total_amount')); ?>:
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <strong><?php echo e(format_price($invoice->amount)); ?></strong>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/plugins/hotel/resources/views/invoices/show.blade.php ENDPATH**/ ?>