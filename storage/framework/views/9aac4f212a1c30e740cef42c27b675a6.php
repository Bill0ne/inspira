...
<?php endif; ?>
        ...
        <?php if(($memoryLimit && $memoryLimit != -1 && $memoryLimit < $requiredMemoryLimit) || ($maximumExecutionTime && $maximumExecutionTime < $requiredMaximumExecutionTime)): ?>
            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
                    ...
                    <ul class="mt-3 mb-0 ps-2">
                        <?php if($memoryLimit && $memoryLimit < $requiredMemoryLimit): ?>
                            <li class="mb-2"><code>memory_limit</code>: <code><?php echo e($memoryLimit); ?>M</code> =>
                                <code><?php echo e($requiredMemoryLimit); ?>M</code></li>
                        <?php endif; ?>
...
<?php $component->withAttributes(['type' => 'warning','title' => 'You haven\'t activated your license yet!','important' => true]); ?>
                <p class="mt-3 mb-0">
                    ...
                    Please go to <a href="<?php echo e(route('settings.general')); ?>" class="fw-bold text-white">settings</a> page
...
<?php $component->withAttributes(['dir' => 'ltr']); ?>
                    <h3 class="text-success mb-4">
                        <?php echo e(__('A new version (:version / released on :date) is available to update!', ['version' => $latestUpdate->version, 'date' => BaseHelper::formatDate($latestUpdate->releasedDate)])); ?>
...
<?php $component->withAttributes(['dir' => 'ltr']); ?>
                    <?php if(!empty($latestUpdate)): ?>
                        ...
                        >
                            <?php if(!$isOutdated): ?>
                                <h3 class="text-success"><?php echo e(__('The system is up-to-date. There are no new versions to update!')); ?></h3>
                            <?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="mb-0 text-success"><?php echo e(__('The system is up-to-date. There are no new versions to update!')); ?></p>
                    <?php endif; ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/core/base/resources/views/system/updater.blade.php ENDPATH**/ ?>