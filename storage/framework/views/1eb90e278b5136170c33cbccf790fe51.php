...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal','data' => ['id' => ''.e($name).'-modal','title' => __('Update :name', ['name' => $label]),'size' => 'lg','class' => 'crop-image-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => ''.e($name).'-modal','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Update :name', ['name' => $label])),'size' => 'lg','class' => 'crop-image-modal']); ?>
            <div class="row">
                <div class="col-md-8">
...
<?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/core/base/resources/views/components/crop-image.blade.php ENDPATH**/ ?>