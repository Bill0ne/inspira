...
<style>
/* --- Compact form --- */
.inspira-form{--pri:<?php echo e($primary); ?>}
...
<div class="inspira-form">
  <div class="section-title"><h2><?php echo e(__('Buchungsformular')); ?></h2></div>
  <p style="margin:0 0 6px;color:#334155;font-size:14px"><?php echo e(__('Bitte einen Slot buchen:')); ?></p>

  <form id="<?php echo e($formUid); ?>"
        class="form-booking"
        action="<?php echo e($availableForBooking ? route('public.booking') : route('public.rooms')); ?>"
        method="<?php echo e($availableForBooking ? 'POST' : 'GET'); ?>">
    ...
    <div class="slot-row">
      <label class="slot-pill">
        ...
        <input type="text" class="js-date" placeholder="TT.MM.JJJJ" value="<?php echo e($prefillDate); ?>" autocomplete="off" readonly>
      </label>
      <label class="slot-pill time">
        <span class="ti ti-clock" aria-hidden="true"></span>
        <input type="text" class="js-start" placeholder="HH:MM" value="<?php echo e($prefillStart); ?>" autocomplete="off" readonly>
      </label>
      <label class="slot-pill time">
        <span class="ti ti-clock" aria-hidden="true"></span>
        <input type="text" class="js-end" placeholder="HH:MM" value="<?php echo e($prefillEnd); ?>" autocomplete="off" readonly>
      </label>
    </div>
    ...
    <div style="margin-top:10px">
      <button class="inspira-cta" type="submit">
        <?php echo e($availableForBooking ? __('Jetzt Buchen') : __('Verfügbarkeit prüfen')); ?>
...
(function(){
  ...
  onReady(function(){
    ...
    const form   = document.getElementById('<?php echo e($formUid); ?>');
