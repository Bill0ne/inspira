...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::twig-editor','data' => ['variables' => EmailHandler::getVariables($pluginData['type'], $pluginData['name'], $pluginData['template_file']),'functions' => EmailHandler::getFunctions(),'value' => $emailContent,'name' => 'email_content','mode' => 'html']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variables' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(EmailHandler::getVariables($pluginData['type'], $pluginData['name'], $pluginData['template_file'])),'functions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(EmailHandler::getFunctions()),'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailContent),'name' => 'email_content','mode' => 'html']); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'warning','class' => 'mt-4','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::base.email_template.missing_icons'))]); ?>
                <p class="mt-2">
                    <?php echo BaseHelper::clean(trans('core/base::base.email_template.missing_icons_description', [
...
<?php $component->withAttributes(['class' => 'mt-4','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('core/base::base.email_template.usage'))]); ?>
            <ul class="mt-2">
                <li>
                    <p>
                        <?php echo BaseHelper::clean(trans('core/base::base.email_template.icon_variable_usage_description', [
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/core/setting/resources/views/email-template-edit.blade.php ENDPATH**/ ?>