            ...
            <div class="col-sm-12 col-md-12 col-lg-4 sidebar">
                <aside>
                    ...
                    <div class="form-information text-white">
                        ...
                        <div>
                            <p><?php echo e(__('Check-In')); ?>: <?php echo e($startDate->translatedFormat('l, d M, Y')); ?></p>
                            <p><?php echo e(__('Check-Out')); ?>: <?php echo e($endDate->translatedFormat('l, d M, Y')); ?></p>
                            ...
                            <?php if($discountAmount > 0): ?>
                                <div class="kv">
                                    ...
                                    <b class="text-light text-decoration-line-through opacity-75"><?php echo e(format_price($basePrice)); ?></b>
                                </div>
                                <div class="kv">
                                    <span class="text-light"><?php echo e(__('Discounted Price')); ?></span>
                                    <b class="fw-bold text-warning amount-text"><?php echo e(format_price($amount)); ?></b>
                                </div>
                                <div class="kv small mt-1">
                                    <i class="fas fa-tag me-1 text-warning"></i>
                                    <span class="text-warning"><?php echo e(__('You save :amount', ['amount' => format_price($discountAmount)])); ?></span>
                                </div>
                            <?php else: ?>
                                <div class="kv">
...
<?php if(is_plugin_active('payment')): ?>
    ...
    ?>
<?php endif; ?>
<?php /**PATH /home/u296731902/domains/inspira-zentrum.de/public_html/platform/themes/riorelax/views/hotel/booking.blade.php ENDPATH**/ ?>