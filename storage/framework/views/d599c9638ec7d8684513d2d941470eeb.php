...
<div class="personal-dashboard-greeting position-relative overflow-hidden rounded-4 text-white" style="background: linear-gradient(135deg, #4f46e5 0%, #1d4ed8 45%, #0ea5e9 100%);">
    ...
    <div class="position-relative p-4 p-lg-5">
        <span class="badge bg-white text-primary-emphasis fw-semibold text-uppercase mb-3">
            <?php echo e(trans('plugins/personal-dashboard::widgets.greeting_badge')); ?>

        </span>

        <h2 class="fw-bold display-6 mb-2">
            <?php echo e(trans('plugins/personal-dashboard::widgets.greeting_heading', ['name' => $userName])); ?>

        </h2>

        <p class="fs-6 text-white-50 mb-4">
            <?php echo e(trans('plugins/personal-dashboard::widgets.greeting_message')); ?>
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="text-white">
                <div class="text-uppercase small fw-semibold text-white-50"><?php echo e(trans('plugins/personal-dashboard::widgets.current_user')); ?></div>
                <div class="fs-4 fw-bold"><?php echo e($userName); ?></div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\xampp\htdocs\inspira\platform/plugins/personal-dashboard/resources/views/widgets/greeting.blade.php ENDPATH**/ ?>