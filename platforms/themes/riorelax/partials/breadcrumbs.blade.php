...
.breadcrumb-area.breadcrumb--compact{
  position: relative;
  display: flex;
  align-items: flex-end !important;   /* unten ausrichten (übersteuert .align-items-center) */
...
/* Inhalt-Wrapper: volle Breite, keine erzwungene Mindesthöhen */
...
.breadcrumb-area.breadcrumb--compact .breadcrumb-title{
  ...
  text-align: center;
  margin: 0 auto;
  padding-bottom: 12px;               /* Abstand zum unteren Rand */
  width: 100%;
}

/* Der innere .breadcrumb-wrap um <nav> bleibt block, damit sich die Crumbs normal verhalten */
.breadcrumb-area.breadcrumb--compact .breadcrumb-title > .breadcrumb-wrap{
  display: block;
}

/* Typo (aktuell 24px/500 – wenn wieder 16px gewünscht, Werte hier tauschen) */
