...
mix
    ...
    .sass(`${source}/assets/sass/booking-widget.scss`, `${dist}/css`)
    ...
    .js(`${source}/assets/js/checkout-core.js`, `${dist}/js`)
    .js(`${source}/assets/js/checkout-commerce.js`, `${dist}/js`)
    .js(`${source}/assets/js/course-checkout.js`, `${dist}/js`)
    .js(`${source}/assets/js/datetime.js`, `${dist}/js`)
    .js(`${source}/assets/js/booking-widget.js`, `${dist}/js`)

if (mix.inProduction()) {
    mix
        .copy(`${dist}/css/date.css`, `${source}/public/css`)
        .copy(`${dist}/css/booking-widget.css`, `${source}/public/css`)
        ...
        .copy(`${dist}/js/checkout-core.js`, `${source}/public/js`)
        .copy(`${dist}/js/checkout-commerce.js`, `${source}/public/js`)
        .copy(`${dist}/js/course-checkout.js`, `${source}/public/js`)
        .copy(`${dist}/js/datetime.js`, `${source}/public/js`)
        .copy(`${dist}/js/booking-widget.js`, `${source}/public/js`)
