...
@endphp
<div class="text-muted small course-price-helper" data-tax-rates='@json($taxRates)' data-currency='@json($currencyFormat)' data-price-field="#price" data-tax-field="#tax_id" data-selected-tax="{{ $selectedTaxId }}">
