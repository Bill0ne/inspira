...
class ContactForm extends FormFront
{
    ...
    public function setup(): void
    {
        ...
        Theme::asset()
            ->usePath(false)
            ->add('contact-css', asset('vendor/core/plugins/contact/css/contact-public.css'), [], [], '1.2.2');
        ...
        $this
            ...
            ->add(
                'inspira_inline_css',
                HtmlField::class,
                HtmlFieldOption::make()->content(<<<'HTML'
<style>
/* ---- Inspira Contact Modern UI 1.2.2 ---- */
...
.contact-form .contact-form-input:focus{
  border-color:#5E8E84 !important;
  box-shadow:0 0 0 3px rgba(94,142,132,.15) !important;
...
.contact-form input[type="submit"]{
  display:block;width:100%;background:#5E8E84 !important;color:#fff !important;
  border:1px solid #5E8E84 !important;border-radius:0 !important;padding:16px 22px !important;
  font-weight:600; line-height:1.3; text-align:center;
  transition:background-color .2s ease, border-color .2s ease;
}
.contact-form .contact-button:hover,
.contact-form button[type="submit"]:hover,
.contact-form input[type="submit"]:hover{ background:#4F7B72 !important;border-color:#4F7B72 !important;}
/* Terms block robust */
.contact-form .contact-terms{display:flex; align-items:center; gap:.5rem; margin:12px 0 16px; width:100%;}
.contact-form .contact-terms .form-check-input{
    margin:0; 
    position:static; 
    float:none;
    width: 18px;
...
.contact-form .contact-terms .form-check-label{
    margin:0; 
    line-height:1.5; 
    white-space:normal; 
...
->add(
                        ...
                        $form
                            ->add(
                                ...
                                TextFieldOption::make()
                                    ...
                                    ->cssClass($this->formInputClass . ' contact-form-input')
                                    ->maxLength(-1)
                            );
                    })
            ...
            // CHECKBOX VOR DEM BUTTON EINFÜGEN
            ->when(setting('contact_form_show_terms_checkbox', true), function (self $form): void {
                $form->add(
                    'agree_terms_and_policy_html',
                    HtmlField::class,
                    HtmlFieldOption::make()
                        ->content('<div class="form-check contact-terms">
  <input class="form-check-input" type="checkbox" id="agree_terms_and_policy" name="agree_terms_and_policy" value="1" required>
  <label class="form-check-label" for="agree_terms_and_policy">
    Ich stimme den Nutzungsbedingungen und Datenschutzrichtlinien zu.
  </label>
</div>')
                        ->wrapperAttributes(['class' => 'contact-form-input-group col-12'])
                );
            })
            ->addWrappedField(
                'submit',
