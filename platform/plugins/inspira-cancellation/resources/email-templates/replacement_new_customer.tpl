...
<div class="bb-main-content">
    <table class="bb-box" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td class="bb-content">
                    <h1 class="bb-text-center">{{ 'plugins/inspira-cancellation::cancellation.email.templates.replacement_new_customer.title' | trans }}</h1>

                    <p class="bb-text-center bb-mb-md">{{ 'plugins/inspira-cancellation::cancellation.email.templates.replacement_new_customer.description' | trans }}</p>

                    <p>{{ 'plugins/inspira-cancellation::cancellation.email.variables.new_customer_name' | trans }}: <strong>{{ new_customer_name }}</strong></p>
